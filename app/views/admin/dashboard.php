...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
    ...
    <a href="/barbearia/admin/logs" class="bg-gray-900 border border-gray-800 rounded-xl p-6 hover:border-amber-400 transition group">
        <div class="text-amber-400 text-3xl mb-3">📋</div>

        <h2 class="text-xl font-bold group-hover:text-amber-400 transition">Logs</h2>
        
        <p class="text-gray-500 text-sm mt-1">Monitore erros do sistema</p>
    </a>
</div>
